        ...
        <div class="liquidity-main display-flex box-center-start">
          <div class="liquidity-text-box">
            <div class="liquidity-text-item">
              ...
              <div class="text-desc">Writers(Liquidity providers)receive write{{liquidity.list[liquidity.index].currency}} tokens{{liquidity.list[liquidity.index].currency === 'HT' ? '' : '(HRC20)'}}that give them a share in the poots premiums that are distributed to them after the options contracts</div>
            </div>
            <div class="liquidity-text-item">
              <div class="display-flex box-center-Y">
              ...
              <div class="text-desc">Click the"Deposit button and {{amount}} {{liquidity.list[liquidity.index].currency}} will be sent from your Heco address to the liquidity pool contract After the transaction is confirmed by miners, you will</div>
            </div>
          </div>
          <div class="box-flex1">
